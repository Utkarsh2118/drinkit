...
export class InvoiceService {
  ...
  public static buildInvoiceData(order: Order): OrderInvoiceData {
    const store = db.getStores().find(s => s.id === order.storeId) || {
      id: order.storeId || 'store_noida_sec18',
      name: order.storeName || 'DrinkIt Micro-Warehouse',
      code: 'HUB-UP-01',
      address: 'Pocket E, Sector 18, Noida',
      city: 'Noida',
      state: 'Uttar Pradesh',
      postalCodes: ['201301'],
      latitude: 28.5708,
    ...
    return {
      ...
      seller: {
        ...
        gstin: 'CONFIGURE_PER_STORE',
        exciseLicense: 'CONFIGURE_PER_LICENSED_STORE',
        fssaiLicense: 'CONFIGURE_PER_STORE',
      },
      ...
      company: {
        ...
        cin: 'U74999UP2026PTC184920',
        gstin: '09AAACD1234F1Z5',
        fssaiLicense: '10022043000452',
        stateExciseLicense: 'UP-EXC-2026-NOI-0042',
        registeredOffice: 'Sector 18 Commercial Hub, Noida, Uttar Pradesh 201301',
        supportEmail: 'orders@drinkit.app',
        supportPhone: '+91 120 4567 8900',
      },
      store: {
        id: store.id,
        name: store.name,
        code: store.code || 'HUB-UP-01',
      ...
      customer: {
        ...
        deliveryAddress: {
          ...
          city: order.deliveryAddress?.city || 'Noida',
          state: order.deliveryAddress?.state || 'Uttar Pradesh',
          postalCode: order.deliveryAddress?.postalCode || '201301',
        },
      },
      payment: {
